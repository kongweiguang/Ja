...
const methods = [
  ...
  "plan/revisions/list", "goal/evidence/list", "goal/create", "goal/plan/attach", "goal/plan/detach",
  "goal/pause", "goal/resume", "goal/stop", "goal/input/respond", "plan/create", "plan/draft/save",
  "plan/draft/discard", "plan/propose", "plan/approve", "plan/execute", "plan/reject",
...
const events = [
  ...
  "turn/input-consumed", "assistant/model-step-committed",
...
function initializeResult() {
  return {
    ...
    protocolMinor: 0,
    serverInstanceId,
    runtime: { engine: "ja-kernel", engineVersion: "0.1.0" },
    capabilities: {
      methods,
      events,
