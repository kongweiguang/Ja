...
/** 验证 Settings catalog 入站边界只消费 catalog 用例，并保持冻结 JA-RPC v2 Wire 结构。 */
    ...
    */
    ...
    private static RpcServiceBindings bindings(CatalogUseCase catalog) {
        return new RpcServiceBindings(
                unsupported(WorkspaceUseCase.class), unsupported(ThreadUseCase.class),
    ...
    private static final class RecordingCatalog implements CatalogUseCase {
        ...
        public CursorPage<SkillDescriptor> listSkills(String cursor, int limit) {
            ...
            return new CursorPage<>(List.of(new SkillDescriptor(
                    "skill_fixture", "Fixture", "builtin", true, "available", "安全描述")),
                    "skill_next");
        }
